...
class TestCatalogApi(APITestCase):
    ...
    def test_batch_delete_catalog_objects(self):
        coffee_id = self.catalog_fixture.object_id(self.catalog_fixture.CLIENT_ID_COFFEE)
        small_coffee_id = self.catalog_fixture.object_id(self.catalog_fixture.CLIENT_ID_COFFEE_SMALL)
        large_coffee_id = self.catalog_fixture.object_id(self.catalog_fixture.CLIENT_ID_COFFEE_LARGE)
        small_tea_id = self.catalog_fixture.object_id(self.catalog_fixture.CLIENT_ID_TEA_SMALL)
    ...
    def test_batch_retrieve_catalog_objects(self):
        coffee_id = self.catalog_fixture.object_id(self.catalog_fixture.CLIENT_ID_COFFEE)
        sales_tax_id = self.catalog_fixture.object_id(self.catalog_fixture.CLIENT_ID_SALES_TAX)
        beverages_id = self.catalog_fixture.object_id(self.catalog_fixture.CLIENT_ID_BEVERAGES)
        milks_id = self.catalog_fixture.object_id(self.catalog_fixture.CLIENT_ID_MILKS)
    ...
    def test_update_item_modifier_lists(self):
        coffee_id = self.catalog_fixture.object_id(self.catalog_fixture.CLIENT_ID_COFFEE)
        milks_id = self.catalog_fixture.object_id(self.catalog_fixture.CLIENT_ID_MILKS)
        syrups_id = self.catalog_fixture.object_id(self.catalog_fixture.CLIENT_ID_SYRUPS)
