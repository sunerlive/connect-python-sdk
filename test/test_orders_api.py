...
class TestOrdersApi(APITestCase):
    ...
    def test_create_order_with_catalog_objects(self):
        ...
        soy_milk_id = self.catalog_fixture.object_id(self.catalog_fixture.CLIENT_ID_MILK_SOY)
        amount_discount_id = self.catalog_fixture.object_id(self.catalog_fixture.CLIENT_ID_AMOUNT_DISCOUNT)
